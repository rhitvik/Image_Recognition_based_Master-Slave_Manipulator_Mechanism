...
def actuate(str):
    ...
    if (str == "Dextral"):
    ## make the actuator to rotate
        io.output(motor1_switch, 0)
        io.output(motor1_inA, 1)
        io.output(motor1_inB, 0)
        io.output(motor1_switch, 1)
        
    elif (str == "Sinistral"):
        ## make the actuator to rotate
        io.output(motor1_switch, 0)
        io.output(motor1_inA, 0)
        io.output(motor1_inB, 1)
        io.output(motor1_switch, 1)
        
    elif (str == "Open_Claw"):
        io.output(motor2_switch, 0)
        io.output(motor2_inA, 0)
        io.output(motor2_inB, 1)
        io.output(motor2_switch, 1)
        
    elif (str == "Close_Claw"):
        io.output(motor2_switch, 0)
        io.output(motor2_inA, 1)
        io.output(motor2_inB, 0)
        io.output(motor2_switch, 1)
...
# motor 1 wrist movement
# motor 2 claw control

    io.setup(motor1_switch , io.OUT)   # enable 1 | motor 1 turn-on/off
    io.setup(motor2_switch, io.OUT)   # enable 2 | motor 2 turn-on/off

    io.setup(motor1_inA ,io.OUT)  
    io.setup(motor1_inB, io.OUT)
    io.setup(motor2_inA ,io.OUT)  
    io.setup(motor2_inB, io.OUT)  
